                        ...
                        <form role="form" action="reviewAction.jsp" method="post" target="zeroFrame">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <%--#########################여기 바꿨음###################--%>
                                    <input type="text" class="form-control" name="mid" id="exampleInputEmail1" placeholder="your name" value="khj">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">감상</label>
                                    <%--#########################여기 바꿨음###################--%>
                                    <input type="text" class="form-control" name="cmt"  placeholder="your connect" value="gooooooood">
                                </div>
                            </div>
                            <!-- /.box-body -->
